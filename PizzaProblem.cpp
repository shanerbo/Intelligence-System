...
int main() {
  ...
  pizzas = {18, 46, 14, 26, 17, 41, 38, 40, 34, 23, 16, 41, 11, 34, 37, 48, 10,
            ...
            49, 47, 47, 35, 20, 20, 42, 24, 10, 22, 44, 45, 24, 35, 42, 32, 46,
            32, 39, 27, 45, 48, 10, 34, 42, 18, 43, 45, 23, 37, 13, 40, 33, 46,
            45, 22, 42, 36, 41, 32, 36, 32, 10, 44, 44, 49, 49, 31, 39, 48, 11,
            24, 50, 21, 45, 47, 21, 15, 45, 26, 12, 14, 15, 11, 38, 10, 27, 25,
            27, 17, 49, 21, 32, 28, 14, 20, 20, 26, 43, 20, 27, 28, 39, 30, 41,
            40, 17, 11, 29, 34, 31, 36, 22, 26, 16, 26, 42, 23, 48, 37, 11, 24,
            11, 35, 19, 12, 20, 38, 42, 37, 44, 24, 50, 43, 38};
  buy = {13, 18, 20, 10, 16, 20, 19, 15, 20, 20, 16, 10, 14, 12, 13, 10, 14,
         11, 11, 14, 14, 12, 16, 19, 14, 12, 10, 18, 10, 19, 13, 19, 17, 12,
         19, 18, 10, 16, 13, 15, 11, 13, 19, 20, 16, 19, 13, 17, 11, 20, 16,
         14, 18, 17, 10, 15, 19, 16, 14, 10, 12, 13, 15, 19, 12, 15, 16, 13,
         14, 20, 11, 16, 18, 15, 20, 18, 17, 18, 13, 11, 10, 11, 12, 12, 12,
         18, 13, 14, 15, 19, 18, 14, 15, 15, 15, 11, 14, 13, 19, 17};
  free = {6,  9, 9, 5, 7, 5,  8, 5, 8,  6,  6,  7,  5,  9, 9, 8,  5, 9, 9, 6,
          9,  5, 7, 7, 7, 9,  9, 5, 8,  7,  5,  5,  7,  5, 9, 10, 5, 5, 8, 5,
          5,  6, 6, 9, 8, 6,  5, 8, 6,  10, 6,  6,  10, 5, 8, 8,  9, 7, 9, 7,
          10, 8, 7, 5, 6, 10, 7, 5, 5,  5,  7,  10, 9,  7, 8, 8,  7, 8, 5, 5,
          7,  9, 8, 5, 7, 6,  9, 9, 10, 8,  10, 7,  7,  6, 9, 6,  7, 6, 6, 7};
  coupons = convert(buy, free);
  res = pizzaProblem->miniCost(pizzas, coupons);
